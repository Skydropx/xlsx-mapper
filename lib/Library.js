...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function convert(reader) {
      ...
      var worksheet = this._sheetFromRows();
    ...
    key: '_sheetFromRows',
    value: function _sheetFromRows() {
      var ws = {};
      var range = { s: { c: 0, r: 0 }, e: { c: 0, r: this.reader.rows.length } };

      for (var R = 0; R !== this.reader.rows.length; ++R) {
        var skydropCells = this.toSkydropCells(this.reader.rows[R]);
      ...
      workbook.SheetNames.forEach(function (sheetName) {
        ...
        _xlsx2.default.utils.sheet_to_json(worksheet).forEach(function (row) {
          ...
          for (key in _this.columnsToMatch) {
            obj[_this.columnsToMatch[key]] = row[_this.columnsToMatch[key]];
          }_this.rows.push(obj);
        });
      });
    }
